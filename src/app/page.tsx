  ...
  const copy = {
    id: {
      ...
      modules: [
        ...
        { href: "/price-master", title: "Master Harga", description: "Kelola harga item per unit dan tipe harga (purchase, selling, wholesale, retail)." },
    ...
    en: {
      ...
      modules: [
        ...
        { href: "/price-master", title: "Price Master", description: "Manage item prices by unit and price type (purchase, selling, wholesale, retail)." },
